...
@Injectable()
export class RecursivePairwiseNetworkingSortService extends AbstractBinarySortService {
...
@Injectable()
export class IterativePairwiseNetworkingSortService extends RecursivePairwiseNetworkingSortService {
