 ...
 * 重力排序
 */
export class GravitySortAlgorithm extends AbstractDistributionSortAlgorithm<number> {
...
export class SimpleGravitySortAlgorithm extends GravitySortAlgorithm {
