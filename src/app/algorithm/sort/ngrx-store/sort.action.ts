...
import { SortHeapNodeOptionModel, SortMergeWayOptionModel, SortOptionLoadState, SortOrderOptionModel, SortRadixOptionModel } from "./sort.state";
...
export const SORT_HEAP_NODE_OPTION_LOAD_DONE_ACTION = createAction(
    ...
    props<SortOptionLoadState<SortHeapNodeOptionModel>>()
);
