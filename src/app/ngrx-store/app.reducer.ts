...
import { APP_STYLE_CHECK_DONE_ACTION, APP_STYLE_FETCH_DONE_ACTION, APP_STYLE_CHANGE_DONE_ACTION, APP_CONFIG_STYLE_NAME_LOAD_DONE_ACTION, APP_CONFIG_STYLE_COLOR_LOAD_DONE_ACTION, APP_CONFIG_NAVLIST_LOAD_DONE_ACTION, APP_STYLE_THEME_FETCH_DONE_ACTION } from "./app.action";
...
export const APP_CONFIG_REDUCER = createReducer<AppConfigReducerState>(
    { action: '', value: [] },
    on(APP_CONFIG_NAVLIST_LOAD_DONE_ACTION, (state, props) => 
        ({ ...state, action: props.action, value: props.value })),
